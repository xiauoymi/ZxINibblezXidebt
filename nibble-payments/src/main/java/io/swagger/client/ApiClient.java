...
public class ApiClient {
	 ...
	 *            The JSON string
	 * @param containerType
	 *            The container type, one of "list", "array" or ""
	 * @param cls
...
//			proxy.username=quotaguard5456
//					proxy.password=7f827d58659b
//					proxy.url=us-west-static-01.quotaguard.com
//					proxy.port=9293
			String host = "us-west-static-01.quotaguard.com";
			String port = "9293";
			String username = "quotaguard5456";
			String proxyPassword = "7f827d58659b";
			ClientConfig config = new DefaultClientConfig();
			config.getProperties().put(ApacheHttpClientConfig.PROPERTY_PROXY_URI,  "http://" + host + ":" + port + "/");
