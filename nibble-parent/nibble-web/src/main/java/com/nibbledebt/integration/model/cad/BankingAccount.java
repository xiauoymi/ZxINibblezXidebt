...
@XmlType(name = "", propOrder = { "bankingAccountType", "postedDate",
		"availableBalanceAmount", "interestType", "originationDate",
		"openDate", "periodInterestRate", "periodDepositAmount",
		"periodInterestAmount", "interestAmountYtd", "interestPriorAmountYtd",
...
public class BankingAccount extends Account implements Serializable, Equals,
		HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"bankingAccountType", lhsBankingAccountType), LocatorUtils
				.property(thatLocator, "bankingAccountType",
						rhsBankingAccountType), lhsBankingAccountType,
				rhsBankingAccountType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "interestType",
				lhsInterestType), LocatorUtils.property(thatLocator,
				"interestType", rhsInterestType), lhsInterestType,
				rhsInterestType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"originationDate", lhsOriginationDate), LocatorUtils.property(
				thatLocator, "originationDate", rhsOriginationDate),
				lhsOriginationDate, rhsOriginationDate)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "openDate", lhsOpenDate),
				LocatorUtils.property(thatLocator, "openDate", rhsOpenDate),
				lhsOpenDate, rhsOpenDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"periodInterestRate", lhsPeriodInterestRate), LocatorUtils
				.property(thatLocator, "periodInterestRate",
						rhsPeriodInterestRate), lhsPeriodInterestRate,
				rhsPeriodInterestRate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"periodDepositAmount", lhsPeriodDepositAmount), LocatorUtils
				.property(thatLocator, "periodDepositAmount",
						rhsPeriodDepositAmount), lhsPeriodDepositAmount,
				rhsPeriodDepositAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"periodInterestAmount", lhsPeriodInterestAmount), LocatorUtils
				.property(thatLocator, "periodInterestAmount",
						rhsPeriodInterestAmount), lhsPeriodInterestAmount,
				rhsPeriodInterestAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestAmountYtd", lhsInterestAmountYtd), LocatorUtils
				.property(thatLocator, "interestAmountYtd",
						rhsInterestAmountYtd), lhsInterestAmountYtd,
				rhsInterestAmountYtd)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestPriorAmountYtd", lhsInterestPriorAmountYtd),
				LocatorUtils.property(thatLocator, "interestPriorAmountYtd",
						rhsInterestPriorAmountYtd), lhsInterestPriorAmountYtd,
				rhsInterestPriorAmountYtd)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "maturityDate",
				lhsMaturityDate), LocatorUtils.property(thatLocator,
				"maturityDate", rhsMaturityDate), lhsMaturityDate,
				rhsMaturityDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"maturityAmount", lhsMaturityAmount), LocatorUtils.property(
				thatLocator, "maturityAmount", rhsMaturityAmount),
				lhsMaturityAmount, rhsMaturityAmount)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"bankingAccountType", theBankingAccountType), currentHashCode,
				theBankingAccountType);
		...
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "interestType",
						theInterestType), currentHashCode, theInterestType);

		Calendar theOriginationDate = getOriginationDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"originationDate", theOriginationDate), currentHashCode,
				theOriginationDate);

		Calendar theOpenDate = getOpenDate();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "openDate", theOpenDate),
				currentHashCode, theOpenDate);

		BigDecimal thePeriodInterestRate = getPeriodInterestRate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"periodInterestRate", thePeriodInterestRate), currentHashCode,
				thePeriodInterestRate);

		BigDecimal thePeriodDepositAmount = getPeriodDepositAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"periodDepositAmount", thePeriodDepositAmount),
				currentHashCode, thePeriodDepositAmount);

		BigDecimal thePeriodInterestAmount = getPeriodInterestAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"periodInterestAmount", thePeriodInterestAmount),
				currentHashCode, thePeriodInterestAmount);

		BigDecimal theInterestAmountYtd = getInterestAmountYtd();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestAmountYtd", theInterestAmountYtd), currentHashCode,
				theInterestAmountYtd);

		BigDecimal theInterestPriorAmountYtd = getInterestPriorAmountYtd();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestPriorAmountYtd", theInterestPriorAmountYtd),
				currentHashCode, theInterestPriorAmountYtd);

		Calendar theMaturityDate = getMaturityDate();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "maturityDate",
						theMaturityDate), currentHashCode, theMaturityDate);

		BigDecimal theMaturityAmount = getMaturityAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"maturityAmount", theMaturityAmount), currentHashCode,
				theMaturityAmount);
