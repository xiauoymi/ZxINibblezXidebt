...
@XmlType(name = "", propOrder = { "loanDescription", "loanType", "postedDate",
		"term", "holderName", "lateFeeAmount", "payoffAmount",
		"payoffAmountDate", "referenceNumber", "originalMaturityDate",
		"taxPayeeName", "principalBalance", "escrowBalance", "interestRate",
		"interestPeriod", "initialAmount", "initialDate",
		"nextPaymentPrincipalAmount", "nextPaymentInterestAmount",
		"nextPayment", "nextPaymentDate", "lastPaymentDueDate",
		"lastPaymentReceiveDate", "lastPaymentAmount",
		"lastPaymentPrincipalAmount", "lastPaymentInterestAmount",
		"lastPaymentEscrowAmount", "lastPaymentLastFeeAmount",
		"lastPaymentLateCharge", "principalPaidYtd", "interestPaidYtd",
		"insurancePaidYtd", "taxPaidYtd", "autopayEnrolled", "collateral",
		"currentSchool", "firstPaymentDate", "guarantor", "firstMortgage",
		"loanPaymentFreq", "paymentMinAmount", "originalSchool",
		"recurringPaymentAmount", "lender", "endingBalanceAmount",
		"availableBalanceAmount", "loanTermType", "noOfPayments",
		"balloonAmount", "projectedInterest", "interestPaidLtd",
		"interestRateType", "loanPaymentType", "remainingPayments" })
@XmlRootElement(name = "LoanAccount", namespace = "http://schema.intuit.com/platform/fdatafeed/loanaccount/v1")
public class LoanAccount extends Account implements Serializable, Equals,
		HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"loanDescription", lhsLoanDescription), LocatorUtils.property(
				thatLocator, "loanDescription", rhsLoanDescription),
				lhsLoanDescription, rhsLoanDescription)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "loanType", lhsLoanType),
				LocatorUtils.property(thatLocator, "loanType", rhsLoanType),
				lhsLoanType, rhsLoanType)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "postedDate",
						lhsPostedDate), LocatorUtils.property(thatLocator,
						"postedDate", rhsPostedDate), lhsPostedDate,
						rhsPostedDate)) {
			return false;
		}
		...
		if (!strategy.equals(
				...
				LocatorUtils.property(thatLocator, "term", rhsTerm), lhsTerm,
				rhsTerm)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "holderName",
						lhsHolderName), LocatorUtils.property(thatLocator,
						"holderName", rhsHolderName), lhsHolderName,
						rhsHolderName)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lateFeeAmount", lhsLateFeeAmount), LocatorUtils.property(
				thatLocator, "lateFeeAmount", rhsLateFeeAmount),
				lhsLateFeeAmount, rhsLateFeeAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "payoffAmount",
				lhsPayoffAmount), LocatorUtils.property(thatLocator,
				"payoffAmount", rhsPayoffAmount), lhsPayoffAmount,
				rhsPayoffAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"payoffAmountDate", lhsPayoffAmountDate),
				LocatorUtils.property(thatLocator, "payoffAmountDate",
						rhsPayoffAmountDate), lhsPayoffAmountDate,
				rhsPayoffAmountDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"referenceNumber", lhsReferenceNumber), LocatorUtils.property(
				thatLocator, "referenceNumber", rhsReferenceNumber),
				lhsReferenceNumber, rhsReferenceNumber)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"originalMaturityDate", lhsOriginalMaturityDate), LocatorUtils
				.property(thatLocator, "originalMaturityDate",
						rhsOriginalMaturityDate), lhsOriginalMaturityDate,
				rhsOriginalMaturityDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "taxPayeeName",
				lhsTaxPayeeName), LocatorUtils.property(thatLocator,
				"taxPayeeName", rhsTaxPayeeName), lhsTaxPayeeName,
				rhsTaxPayeeName)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"principalBalance", lhsPrincipalBalance),
				LocatorUtils.property(thatLocator, "principalBalance",
						rhsPrincipalBalance), lhsPrincipalBalance,
				rhsPrincipalBalance)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowBalance", lhsEscrowBalance), LocatorUtils.property(
				thatLocator, "escrowBalance", rhsEscrowBalance),
				lhsEscrowBalance, rhsEscrowBalance)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestPeriod", lhsInterestPeriod), LocatorUtils.property(
				thatLocator, "interestPeriod", rhsInterestPeriod),
				lhsInterestPeriod, rhsInterestPeriod)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"initialAmount", lhsInitialAmount), LocatorUtils.property(
				thatLocator, "initialAmount", rhsInitialAmount),
				lhsInitialAmount, rhsInitialAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "initialDate",
				lhsInitialDate), LocatorUtils.property(thatLocator,
				"initialDate", rhsInitialDate), lhsInitialDate, rhsInitialDate)) {
			return false;
		}

		BigDecimal lhsNextPaymentPrincipalAmount = getNextPaymentPrincipalAmount();

		BigDecimal rhsNextPaymentPrincipalAmount = that
				.getNextPaymentPrincipalAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"nextPaymentPrincipalAmount", lhsNextPaymentPrincipalAmount),
				LocatorUtils.property(thatLocator,
						"nextPaymentPrincipalAmount",
						rhsNextPaymentPrincipalAmount),
				lhsNextPaymentPrincipalAmount, rhsNextPaymentPrincipalAmount)) {
			return false;
		}

		BigDecimal lhsNextPaymentInterestAmount = getNextPaymentInterestAmount();

		BigDecimal rhsNextPaymentInterestAmount = that
				.getNextPaymentInterestAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"nextPaymentInterestAmount", lhsNextPaymentInterestAmount),
				LocatorUtils.property(thatLocator, "nextPaymentInterestAmount",
						rhsNextPaymentInterestAmount),
				lhsNextPaymentInterestAmount, rhsNextPaymentInterestAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "nextPayment",
				lhsNextPayment), LocatorUtils.property(thatLocator,
				"nextPayment", rhsNextPayment), lhsNextPayment, rhsNextPayment)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"nextPaymentDate", lhsNextPaymentDate), LocatorUtils.property(
				thatLocator, "nextPaymentDate", rhsNextPaymentDate),
				lhsNextPaymentDate, rhsNextPaymentDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentDueDate", lhsLastPaymentDueDate), LocatorUtils
				.property(thatLocator, "lastPaymentDueDate",
						rhsLastPaymentDueDate), lhsLastPaymentDueDate,
				rhsLastPaymentDueDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentReceiveDate", lhsLastPaymentReceiveDate),
				LocatorUtils.property(thatLocator, "lastPaymentReceiveDate",
						rhsLastPaymentReceiveDate), lhsLastPaymentReceiveDate,
				rhsLastPaymentReceiveDate)) {
			return false;
		}
		...
		BigDecimal rhsLastPaymentPrincipalAmount = that
				.getLastPaymentPrincipalAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentPrincipalAmount", lhsLastPaymentPrincipalAmount),
				LocatorUtils.property(thatLocator,
						"lastPaymentPrincipalAmount",
						rhsLastPaymentPrincipalAmount),
				lhsLastPaymentPrincipalAmount, rhsLastPaymentPrincipalAmount)) {
			return false;
		}

		BigDecimal lhsLastPaymentInterestAmount = getLastPaymentInterestAmount();

		BigDecimal rhsLastPaymentInterestAmount = that
				.getLastPaymentInterestAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentInterestAmount", lhsLastPaymentInterestAmount),
				LocatorUtils.property(thatLocator, "lastPaymentInterestAmount",
						rhsLastPaymentInterestAmount),
				lhsLastPaymentInterestAmount, rhsLastPaymentInterestAmount)) {
			return false;
		}

		BigDecimal lhsLastPaymentEscrowAmount = getLastPaymentEscrowAmount();

		BigDecimal rhsLastPaymentEscrowAmount = that
				.getLastPaymentEscrowAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentEscrowAmount", lhsLastPaymentEscrowAmount),
				LocatorUtils.property(thatLocator, "lastPaymentEscrowAmount",
						rhsLastPaymentEscrowAmount),
				lhsLastPaymentEscrowAmount, rhsLastPaymentEscrowAmount)) {
			return false;
		}

		BigDecimal lhsLastPaymentLastFeeAmount = getLastPaymentLastFeeAmount();

		BigDecimal rhsLastPaymentLastFeeAmount = that
				.getLastPaymentLastFeeAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentLastFeeAmount", lhsLastPaymentLastFeeAmount),
				LocatorUtils.property(thatLocator, "lastPaymentLastFeeAmount",
						rhsLastPaymentLastFeeAmount),
				lhsLastPaymentLastFeeAmount, rhsLastPaymentLastFeeAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"lastPaymentLateCharge", lhsLastPaymentLateCharge),
				LocatorUtils.property(thatLocator, "lastPaymentLateCharge",
						rhsLastPaymentLateCharge), lhsLastPaymentLateCharge,
				rhsLastPaymentLateCharge)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"principalPaidYtd", lhsPrincipalPaidYtd),
				LocatorUtils.property(thatLocator, "principalPaidYtd",
						rhsPrincipalPaidYtd), lhsPrincipalPaidYtd,
				rhsPrincipalPaidYtd)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestPaidYtd", lhsInterestPaidYtd), LocatorUtils.property(
				thatLocator, "interestPaidYtd", rhsInterestPaidYtd),
				lhsInterestPaidYtd, rhsInterestPaidYtd)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"insurancePaidYtd", lhsInsurancePaidYtd),
				LocatorUtils.property(thatLocator, "insurancePaidYtd",
						rhsInsurancePaidYtd), lhsInsurancePaidYtd,
				rhsInsurancePaidYtd)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "taxPaidYtd",
						lhsTaxPaidYtd), LocatorUtils.property(thatLocator,
						"taxPaidYtd", rhsTaxPaidYtd), lhsTaxPaidYtd,
						rhsTaxPaidYtd)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"autopayEnrolled", lhsAutopayEnrolled), LocatorUtils.property(
				thatLocator, "autopayEnrolled", rhsAutopayEnrolled),
				lhsAutopayEnrolled, rhsAutopayEnrolled)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "collateral",
						lhsCollateral), LocatorUtils.property(thatLocator,
						"collateral", rhsCollateral), lhsCollateral,
						rhsCollateral)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"currentSchool", lhsCurrentSchool), LocatorUtils.property(
				thatLocator, "currentSchool", rhsCurrentSchool),
				lhsCurrentSchool, rhsCurrentSchool)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"firstPaymentDate", lhsFirstPaymentDate),
				LocatorUtils.property(thatLocator, "firstPaymentDate",
						rhsFirstPaymentDate), lhsFirstPaymentDate,
				rhsFirstPaymentDate)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "guarantor", lhsGuarantor),
				LocatorUtils.property(thatLocator, "guarantor", rhsGuarantor),
				lhsGuarantor, rhsGuarantor)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"firstMortgage", lhsFirstMortgage), LocatorUtils.property(
				thatLocator, "firstMortgage", rhsFirstMortgage),
				lhsFirstMortgage, rhsFirstMortgage)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"loanPaymentFreq", lhsLoanPaymentFreq), LocatorUtils.property(
				thatLocator, "loanPaymentFreq", rhsLoanPaymentFreq),
				lhsLoanPaymentFreq, rhsLoanPaymentFreq)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"originalSchool", lhsOriginalSchool), LocatorUtils.property(
				thatLocator, "originalSchool", rhsOriginalSchool),
				lhsOriginalSchool, rhsOriginalSchool)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"recurringPaymentAmount", lhsRecurringPaymentAmount),
				LocatorUtils.property(thatLocator, "recurringPaymentAmount",
						rhsRecurringPaymentAmount), lhsRecurringPaymentAmount,
				rhsRecurringPaymentAmount)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "lender", lhsLender),
				LocatorUtils.property(thatLocator, "lender", rhsLender),
				lhsLender, rhsLender)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"endingBalanceAmount", lhsEndingBalanceAmount), LocatorUtils
				.property(thatLocator, "endingBalanceAmount",
						rhsEndingBalanceAmount), lhsEndingBalanceAmount,
				rhsEndingBalanceAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"availableBalanceAmount", lhsAvailableBalanceAmount),
				LocatorUtils.property(thatLocator, "availableBalanceAmount",
						rhsAvailableBalanceAmount), lhsAvailableBalanceAmount,
				rhsAvailableBalanceAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "loanTermType",
				lhsLoanTermType), LocatorUtils.property(thatLocator,
				"loanTermType", rhsLoanTermType), lhsLoanTermType,
				rhsLoanTermType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "noOfPayments",
				lhsNoOfPayments), LocatorUtils.property(thatLocator,
				"noOfPayments", rhsNoOfPayments), lhsNoOfPayments,
				rhsNoOfPayments)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"balloonAmount", lhsBalloonAmount), LocatorUtils.property(
				thatLocator, "balloonAmount", rhsBalloonAmount),
				lhsBalloonAmount, rhsBalloonAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"projectedInterest", lhsProjectedInterest), LocatorUtils
				.property(thatLocator, "projectedInterest",
						rhsProjectedInterest), lhsProjectedInterest,
				rhsProjectedInterest)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestPaidLtd", lhsInterestPaidLtd), LocatorUtils.property(
				thatLocator, "interestPaidLtd", rhsInterestPaidLtd),
				lhsInterestPaidLtd, rhsInterestPaidLtd)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestRateType", lhsInterestRateType),
				LocatorUtils.property(thatLocator, "interestRateType",
						rhsInterestRateType), lhsInterestRateType,
				rhsInterestRateType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"loanPaymentType", lhsLoanPaymentType), LocatorUtils.property(
				thatLocator, "loanPaymentType", rhsLoanPaymentType),
				lhsLoanPaymentType, rhsLoanPaymentType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"remainingPayments", lhsRemainingPayments), LocatorUtils
				.property(thatLocator, "remainingPayments",
						rhsRemainingPayments), lhsRemainingPayments,
				rhsRemainingPayments)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"loanDescription", theLoanDescription), currentHashCode,
				theLoanDescription);

		LoanType theLoanType = getLoanType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "loanType", theLoanType),
				currentHashCode, theLoanType);

		Calendar thePostedDate = getPostedDate();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "postedDate", thePostedDate),
				currentHashCode, thePostedDate);
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "holderName", theHolderName),
				currentHashCode, theHolderName);

		BigDecimal theLateFeeAmount = getLateFeeAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lateFeeAmount", theLateFeeAmount), currentHashCode,
				theLateFeeAmount);

		BigDecimal thePayoffAmount = getPayoffAmount();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "payoffAmount",
						thePayoffAmount), currentHashCode, thePayoffAmount);

		Calendar thePayoffAmountDate = getPayoffAmountDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"payoffAmountDate", thePayoffAmountDate), currentHashCode,
				thePayoffAmountDate);

		String theReferenceNumber = getReferenceNumber();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"referenceNumber", theReferenceNumber), currentHashCode,
				theReferenceNumber);

		Calendar theOriginalMaturityDate = getOriginalMaturityDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"originalMaturityDate", theOriginalMaturityDate),
				currentHashCode, theOriginalMaturityDate);

		String theTaxPayeeName = getTaxPayeeName();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "taxPayeeName",
						theTaxPayeeName), currentHashCode, theTaxPayeeName);

		BigDecimal thePrincipalBalance = getPrincipalBalance();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"principalBalance", thePrincipalBalance), currentHashCode,
				thePrincipalBalance);

		BigDecimal theEscrowBalance = getEscrowBalance();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowBalance", theEscrowBalance), currentHashCode,
				theEscrowBalance);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestPeriod", theInterestPeriod), currentHashCode,
				theInterestPeriod);

		BigDecimal theInitialAmount = getInitialAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"initialAmount", theInitialAmount), currentHashCode,
				theInitialAmount);

		Calendar theInitialDate = getInitialDate();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "initialDate", theInitialDate),
				currentHashCode, theInitialDate);

		BigDecimal theNextPaymentPrincipalAmount = getNextPaymentPrincipalAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"nextPaymentPrincipalAmount", theNextPaymentPrincipalAmount),
				currentHashCode, theNextPaymentPrincipalAmount);

		BigDecimal theNextPaymentInterestAmount = getNextPaymentInterestAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"nextPaymentInterestAmount", theNextPaymentInterestAmount),
				currentHashCode, theNextPaymentInterestAmount);

		BigDecimal theNextPayment = getNextPayment();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "nextPayment", theNextPayment),
				currentHashCode, theNextPayment);

		Calendar theNextPaymentDate = getNextPaymentDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"nextPaymentDate", theNextPaymentDate), currentHashCode,
				theNextPaymentDate);

		Calendar theLastPaymentDueDate = getLastPaymentDueDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentDueDate", theLastPaymentDueDate), currentHashCode,
				theLastPaymentDueDate);

		Calendar theLastPaymentReceiveDate = getLastPaymentReceiveDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentReceiveDate", theLastPaymentReceiveDate),
				currentHashCode, theLastPaymentReceiveDate);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentPrincipalAmount", theLastPaymentPrincipalAmount),
				currentHashCode, theLastPaymentPrincipalAmount);

		BigDecimal theLastPaymentInterestAmount = getLastPaymentInterestAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentInterestAmount", theLastPaymentInterestAmount),
				currentHashCode, theLastPaymentInterestAmount);

		BigDecimal theLastPaymentEscrowAmount = getLastPaymentEscrowAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentEscrowAmount", theLastPaymentEscrowAmount),
				currentHashCode, theLastPaymentEscrowAmount);

		BigDecimal theLastPaymentLastFeeAmount = getLastPaymentLastFeeAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentLastFeeAmount", theLastPaymentLastFeeAmount),
				currentHashCode, theLastPaymentLastFeeAmount);

		BigDecimal theLastPaymentLateCharge = getLastPaymentLateCharge();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"lastPaymentLateCharge", theLastPaymentLateCharge),
				currentHashCode, theLastPaymentLateCharge);

		BigDecimal thePrincipalPaidYtd = getPrincipalPaidYtd();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"principalPaidYtd", thePrincipalPaidYtd), currentHashCode,
				thePrincipalPaidYtd);

		BigDecimal theInterestPaidYtd = getInterestPaidYtd();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestPaidYtd", theInterestPaidYtd), currentHashCode,
				theInterestPaidYtd);

		BigDecimal theInsurancePaidYtd = getInsurancePaidYtd();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"insurancePaidYtd", theInsurancePaidYtd), currentHashCode,
				theInsurancePaidYtd);

		BigDecimal theTaxPaidYtd = getTaxPaidYtd();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "taxPaidYtd", theTaxPaidYtd),
				currentHashCode, theTaxPaidYtd);

		Boolean theAutopayEnrolled = isAutopayEnrolled();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"autopayEnrolled", theAutopayEnrolled), currentHashCode,
				theAutopayEnrolled);

		String theCollateral = getCollateral();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "collateral", theCollateral),
				currentHashCode, theCollateral);

		String theCurrentSchool = getCurrentSchool();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"currentSchool", theCurrentSchool), currentHashCode,
				theCurrentSchool);

		Calendar theFirstPaymentDate = getFirstPaymentDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"firstPaymentDate", theFirstPaymentDate), currentHashCode,
				theFirstPaymentDate);

		String theGuarantor = getGuarantor();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "guarantor", theGuarantor),
				currentHashCode, theGuarantor);

		Boolean theFirstMortgage = isFirstMortgage();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"firstMortgage", theFirstMortgage), currentHashCode,
				theFirstMortgage);

		String theLoanPaymentFreq = getLoanPaymentFreq();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"loanPaymentFreq", theLoanPaymentFreq), currentHashCode,
				theLoanPaymentFreq);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"originalSchool", theOriginalSchool), currentHashCode,
				theOriginalSchool);

		BigDecimal theRecurringPaymentAmount = getRecurringPaymentAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"recurringPaymentAmount", theRecurringPaymentAmount),
				currentHashCode, theRecurringPaymentAmount);

		String theLender = getLender();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "lender", theLender),
				currentHashCode, theLender);

		BigDecimal theEndingBalanceAmount = getEndingBalanceAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"endingBalanceAmount", theEndingBalanceAmount),
				currentHashCode, theEndingBalanceAmount);

		BigDecimal theAvailableBalanceAmount = getAvailableBalanceAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"availableBalanceAmount", theAvailableBalanceAmount),
				currentHashCode, theAvailableBalanceAmount);

		LoanTermType theLoanTermType = getLoanTermType();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "loanTermType",
						theLoanTermType), currentHashCode, theLoanTermType);

		Integer theNoOfPayments = getNoOfPayments();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "noOfPayments",
						theNoOfPayments), currentHashCode, theNoOfPayments);

		BigDecimal theBalloonAmount = getBalloonAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"balloonAmount", theBalloonAmount), currentHashCode,
				theBalloonAmount);

		BigDecimal theProjectedInterest = getProjectedInterest();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"projectedInterest", theProjectedInterest), currentHashCode,
				theProjectedInterest);

		BigDecimal theInterestPaidLtd = getInterestPaidLtd();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestPaidLtd", theInterestPaidLtd), currentHashCode,
				theInterestPaidLtd);

		RateType theInterestRateType = getInterestRateType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestRateType", theInterestRateType), currentHashCode,
				theInterestRateType);

		PaymentType theLoanPaymentType = getLoanPaymentType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"loanPaymentType", theLoanPaymentType), currentHashCode,
				theLoanPaymentType);

		Integer theRemainingPayments = getRemainingPayments();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"remainingPayments", theRemainingPayments), currentHashCode,
				theRemainingPayments);
