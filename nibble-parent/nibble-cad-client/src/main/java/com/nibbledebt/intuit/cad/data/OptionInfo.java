...
@XmlType(name="OptionInfo", propOrder={"expireDate", "strikePrice", "optType", "securityUniqueId", "securityUniqueIdType", "sharesPerContract"})
public class OptionInfo extends SecurityInfo
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "strikePrice", lhsStrikePrice), LocatorUtils.property(thatLocator, "strikePrice", rhsStrikePrice), lhsStrikePrice, rhsStrikePrice)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "securityUniqueId", lhsSecurityUniqueId), LocatorUtils.property(thatLocator, "securityUniqueId", rhsSecurityUniqueId), lhsSecurityUniqueId, rhsSecurityUniqueId)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "securityUniqueIdType", lhsSecurityUniqueIdType), LocatorUtils.property(thatLocator, "securityUniqueIdType", rhsSecurityUniqueIdType), lhsSecurityUniqueIdType, rhsSecurityUniqueIdType)) {
      return false;
    }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "strikePrice", theStrikePrice), currentHashCode, theStrikePrice);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "securityUniqueId", theSecurityUniqueId), currentHashCode, theSecurityUniqueId);

    String theSecurityUniqueIdType = getSecurityUniqueIdType();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "securityUniqueIdType", theSecurityUniqueIdType), currentHashCode, theSecurityUniqueIdType);
