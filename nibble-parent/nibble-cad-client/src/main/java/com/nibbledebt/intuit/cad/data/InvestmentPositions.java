...
public class InvestmentPositions implements Serializable, Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		List lhsPositions = (this.positions != null)
				&& (!this.positions.isEmpty()) ? getPositions() : null;

		List rhsPositions = (that.positions != null)
				&& (!that.positions.isEmpty()) ? that.getPositions() : null;
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "positions", lhsPositions),
				LocatorUtils.property(thatLocator, "positions", rhsPositions),
				lhsPositions, rhsPositions)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		List thePositions = (this.positions != null)
				&& (!this.positions.isEmpty()) ? getPositions() : null;
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "positions", thePositions),
				currentHashCode, thePositions);
