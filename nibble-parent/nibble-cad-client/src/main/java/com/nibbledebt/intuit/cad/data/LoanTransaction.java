...
@XmlType(name = "LoanTransaction", namespace = "http://schema.intuit.com/platform/fdatafeed/loantransaction/v1", propOrder = {
		"principalAmount", "interestAmount", "escrowTotalAmount",
		"escrowTaxAmount", "escrowInsuranceAmount", "escrowPmiAmount",
		"escrowFeesAmount", "escrowOtherAmount" })
@XmlRootElement(name = "LoanTransaction", namespace = "http://schema.intuit.com/platform/fdatafeed/loantransaction/v1")
public class LoanTransaction extends Transaction implements Serializable,
		Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"principalAmount", lhsPrincipalAmount), LocatorUtils.property(
				thatLocator, "principalAmount", rhsPrincipalAmount),
				lhsPrincipalAmount, rhsPrincipalAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"interestAmount", lhsInterestAmount), LocatorUtils.property(
				thatLocator, "interestAmount", rhsInterestAmount),
				lhsInterestAmount, rhsInterestAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowTotalAmount", lhsEscrowTotalAmount), LocatorUtils
				.property(thatLocator, "escrowTotalAmount",
						rhsEscrowTotalAmount), lhsEscrowTotalAmount,
				rhsEscrowTotalAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowTaxAmount", lhsEscrowTaxAmount), LocatorUtils.property(
				thatLocator, "escrowTaxAmount", rhsEscrowTaxAmount),
				lhsEscrowTaxAmount, rhsEscrowTaxAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowInsuranceAmount", lhsEscrowInsuranceAmount),
				LocatorUtils.property(thatLocator, "escrowInsuranceAmount",
						rhsEscrowInsuranceAmount), lhsEscrowInsuranceAmount,
				rhsEscrowInsuranceAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowPmiAmount", lhsEscrowPmiAmount), LocatorUtils.property(
				thatLocator, "escrowPmiAmount", rhsEscrowPmiAmount),
				lhsEscrowPmiAmount, rhsEscrowPmiAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowFeesAmount", lhsEscrowFeesAmount),
				LocatorUtils.property(thatLocator, "escrowFeesAmount",
						rhsEscrowFeesAmount), lhsEscrowFeesAmount,
				rhsEscrowFeesAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"escrowOtherAmount", lhsEscrowOtherAmount), LocatorUtils
				.property(thatLocator, "escrowOtherAmount",
						rhsEscrowOtherAmount), lhsEscrowOtherAmount,
				rhsEscrowOtherAmount)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"principalAmount", thePrincipalAmount), currentHashCode,
				thePrincipalAmount);

		BigDecimal theInterestAmount = getInterestAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"interestAmount", theInterestAmount), currentHashCode,
				theInterestAmount);

		BigDecimal theEscrowTotalAmount = getEscrowTotalAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowTotalAmount", theEscrowTotalAmount), currentHashCode,
				theEscrowTotalAmount);

		BigDecimal theEscrowTaxAmount = getEscrowTaxAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowTaxAmount", theEscrowTaxAmount), currentHashCode,
				theEscrowTaxAmount);

		BigDecimal theEscrowInsuranceAmount = getEscrowInsuranceAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowInsuranceAmount", theEscrowInsuranceAmount),
				currentHashCode, theEscrowInsuranceAmount);

		BigDecimal theEscrowPmiAmount = getEscrowPmiAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowPmiAmount", theEscrowPmiAmount), currentHashCode,
				theEscrowPmiAmount);

		BigDecimal theEscrowFeesAmount = getEscrowFeesAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowFeesAmount", theEscrowFeesAmount), currentHashCode,
				theEscrowFeesAmount);

		BigDecimal theEscrowOtherAmount = getEscrowOtherAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"escrowOtherAmount", theEscrowOtherAmount), currentHashCode,
				theEscrowOtherAmount);
