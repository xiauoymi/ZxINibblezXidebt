...
@XmlType(name = "Transaction", namespace = "http://schema.intuit.com/platform/fdatafeed/transaction/v1", propOrder = {
		"id", "currencyType", "institutionTransactionId",
		"correctInstitutionTransactionId", "correctAction",
		"serverTransactionId", "checkNumber", "refNumber",
		"confirmationNumber", "payeeId", "payeeName", "extendedPayeeName",
		"memo", "type", "valueType", "currencyRate", "originalCurrency",
		"postedDate", "userDate", "availableDate", "amount",
		"runningBalanceAmount", "pending", "categorization" })
@XmlSeeAlso({ BankingTransaction.class, CreditCardTransaction.class,
		InvestmentBankingTransaction.class, LoanTransaction.class,
		InvestmentTransaction.class, RewardsTransaction.class })
public class Transaction implements Serializable, Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"institutionTransactionId", lhsInstitutionTransactionId),
				LocatorUtils.property(thatLocator, "institutionTransactionId",
						rhsInstitutionTransactionId),
				lhsInstitutionTransactionId, rhsInstitutionTransactionId)) {
			return false;
		}

		String lhsCorrectInstitutionTransactionId = getCorrectInstitutionTransactionId();

		String rhsCorrectInstitutionTransactionId = that
				.getCorrectInstitutionTransactionId();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"correctInstitutionTransactionId",
				lhsCorrectInstitutionTransactionId), LocatorUtils.property(
				thatLocator, "correctInstitutionTransactionId",
				rhsCorrectInstitutionTransactionId),
				lhsCorrectInstitutionTransactionId,
				rhsCorrectInstitutionTransactionId)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"correctAction", lhsCorrectAction), LocatorUtils.property(
				thatLocator, "correctAction", rhsCorrectAction),
				lhsCorrectAction, rhsCorrectAction)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"serverTransactionId", lhsServerTransactionId), LocatorUtils
				.property(thatLocator, "serverTransactionId",
						rhsServerTransactionId), lhsServerTransactionId,
				rhsServerTransactionId)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "checkNumber",
				lhsCheckNumber), LocatorUtils.property(thatLocator,
				"checkNumber", rhsCheckNumber), lhsCheckNumber, rhsCheckNumber)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "refNumber", lhsRefNumber),
				LocatorUtils.property(thatLocator, "refNumber", rhsRefNumber),
				lhsRefNumber, rhsRefNumber)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"confirmationNumber", lhsConfirmationNumber), LocatorUtils
				.property(thatLocator, "confirmationNumber",
						rhsConfirmationNumber), lhsConfirmationNumber,
				rhsConfirmationNumber)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "payeeId", lhsPayeeId),
				LocatorUtils.property(thatLocator, "payeeId", rhsPayeeId),
				lhsPayeeId, rhsPayeeId)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "payeeName", lhsPayeeName),
				LocatorUtils.property(thatLocator, "payeeName", rhsPayeeName),
				lhsPayeeName, rhsPayeeName)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"extendedPayeeName", lhsExtendedPayeeName), LocatorUtils
				.property(thatLocator, "extendedPayeeName",
						rhsExtendedPayeeName), lhsExtendedPayeeName,
				rhsExtendedPayeeName)) {
			return false;
		}
		...
		if (!strategy.equals(
				...
				LocatorUtils.property(thatLocator, "type", rhsType), lhsType,
				rhsType)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "valueType", lhsValueType),
				LocatorUtils.property(thatLocator, "valueType", rhsValueType),
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"originalCurrency", lhsOriginalCurrency),
				LocatorUtils.property(thatLocator, "originalCurrency",
						rhsOriginalCurrency), lhsOriginalCurrency,
				rhsOriginalCurrency)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "userDate", lhsUserDate),
				LocatorUtils.property(thatLocator, "userDate", rhsUserDate),
				lhsUserDate, rhsUserDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"availableDate", lhsAvailableDate), LocatorUtils.property(
				thatLocator, "availableDate", rhsAvailableDate),
				lhsAvailableDate, rhsAvailableDate)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "amount", lhsAmount),
				LocatorUtils.property(thatLocator, "amount", rhsAmount),
				lhsAmount, rhsAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"runningBalanceAmount", lhsRunningBalanceAmount), LocatorUtils
				.property(thatLocator, "runningBalanceAmount",
						rhsRunningBalanceAmount), lhsRunningBalanceAmount,
				rhsRunningBalanceAmount)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "pending", lhsPending),
				LocatorUtils.property(thatLocator, "pending", rhsPending),
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"categorization", lhsCategorization), LocatorUtils.property(
				thatLocator, "categorization", rhsCategorization),
				lhsCategorization, rhsCategorization)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "id", theId), currentHashCode,
				theId);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"institutionTransactionId", theInstitutionTransactionId),
				currentHashCode, theInstitutionTransactionId);

		String theCorrectInstitutionTransactionId = getCorrectInstitutionTransactionId();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"correctInstitutionTransactionId",
				theCorrectInstitutionTransactionId), currentHashCode,
				theCorrectInstitutionTransactionId);

		TransactionCorrectedType theCorrectAction = getCorrectAction();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"correctAction", theCorrectAction), currentHashCode,
				theCorrectAction);

		String theServerTransactionId = getServerTransactionId();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"serverTransactionId", theServerTransactionId),
				currentHashCode, theServerTransactionId);

		String theCheckNumber = getCheckNumber();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "checkNumber", theCheckNumber),
				currentHashCode, theCheckNumber);

		String theRefNumber = getRefNumber();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "refNumber", theRefNumber),
				currentHashCode, theRefNumber);

		String theConfirmationNumber = getConfirmationNumber();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"confirmationNumber", theConfirmationNumber), currentHashCode,
				theConfirmationNumber);

		String thePayeeId = getPayeeId();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "payeeId", thePayeeId),
				currentHashCode, thePayeeId);

		String thePayeeName = getPayeeName();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "payeeName", thePayeeName),
				currentHashCode, thePayeeName);

		String theExtendedPayeeName = getExtendedPayeeName();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"extendedPayeeName", theExtendedPayeeName), currentHashCode,
				theExtendedPayeeName);
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "valueType", theValueType),
				currentHashCode, theValueType);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"originalCurrency", theOriginalCurrency), currentHashCode,
				theOriginalCurrency);
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "userDate", theUserDate),
				currentHashCode, theUserDate);

		Calendar theAvailableDate = getAvailableDate();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"availableDate", theAvailableDate), currentHashCode,
				theAvailableDate);

		BigDecimal theAmount = getAmount();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "amount", theAmount),
				currentHashCode, theAmount);

		BigDecimal theRunningBalanceAmount = getRunningBalanceAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"runningBalanceAmount", theRunningBalanceAmount),
				currentHashCode, theRunningBalanceAmount);

		boolean thePending = isPending();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "pending", thePending),
				currentHashCode, thePending);

		Categorization theCategorization = getCategorization();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"categorization", theCategorization), currentHashCode,
				theCategorization);
