...
public class Credentials implements Serializable, Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		List lhsCredentials = (this.credentials != null)
				&& (!this.credentials.isEmpty()) ? getCredentials() : null;

		List rhsCredentials = (that.credentials != null)
				&& (!that.credentials.isEmpty()) ? that.getCredentials() : null;
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		List theCredentials = (this.credentials != null)
				&& (!this.credentials.isEmpty()) ? getCredentials() : null;
