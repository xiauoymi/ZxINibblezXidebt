...
public class SAML2AssertionGenerator
{
    ...
    throws SamlAssertionException
  {
    ...
    try {
      ...
      BasicX509Credential basicx509credential = samlCredentials.getX509Credential();
    ...
    throws SamlAssertionException
  {
    try
    {
      ...
      SAMLObjectBuilder samlobjectbuilder1 = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(Assertion.DEFAULT_ELEMENT_NAME);
  ...
  protected Conditions createConditions(DateTime dateTime, String restrictionInfo, int tolerance, int lifeTime)
    throws SamlAssertionException
  {
    SAMLObjectBuilder samlobjectbuilder = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(AudienceRestriction.DEFAULT_ELEMENT_NAME);
    SAMLObjectBuilder samlobjectbuilder1 = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(Audience.DEFAULT_ELEMENT_NAME);
    AudienceRestriction audiencerestriction = (AudienceRestriction)samlobjectbuilder.buildObject();
    Audience audience = (Audience)samlobjectbuilder1.buildObject();
    audience.setAudienceURI(restrictionInfo);
    audiencerestriction.getAudiences().add(audience);
    SAMLObjectBuilder samlobjectbuilder2 = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(Conditions.DEFAULT_ELEMENT_NAME);
  ...
  protected AuthnStatement createAuthnStatement(DateTime dateTime, String authenticationContext, String samlId)
    throws SamlAssertionException
  {
    SAMLObjectBuilder samlobjectbuilder = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(AuthnStatement.DEFAULT_ELEMENT_NAME);
    AuthnStatement authnstatement = (AuthnStatement)samlobjectbuilder.buildObject();
    SAMLObjectBuilder samlobjectbuilder1 = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(AuthnContext.DEFAULT_ELEMENT_NAME);
    AuthnContext authncontext = (AuthnContext)samlobjectbuilder1.buildObject();
    SAMLObjectBuilder samlobjectbuilder2 = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(AuthnContextClassRef.DEFAULT_ELEMENT_NAME);
    AuthnContextClassRef authncontextclassref = (AuthnContextClassRef)samlobjectbuilder2.buildObject();
  ...
  protected AttributeStatement createAttributes(Map<String, String> map)
    throws SamlAssertionException
  {
    SAMLObjectBuilder samlobjectbuilder = (SAMLObjectBuilder)getSAMLBuilder().getBuilder(AttributeStatement.DEFAULT_ELEMENT_NAME);
