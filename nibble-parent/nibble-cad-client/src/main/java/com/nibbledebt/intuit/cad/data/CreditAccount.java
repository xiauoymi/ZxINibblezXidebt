  ...
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "creditAccountType", lhsCreditAccountType), LocatorUtils.property(thatLocator, "creditAccountType", rhsCreditAccountType), lhsCreditAccountType, rhsCreditAccountType)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "detailedDescription", lhsDetailedDescription), LocatorUtils.property(thatLocator, "detailedDescription", rhsDetailedDescription), lhsDetailedDescription, rhsDetailedDescription)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "creditAvailableAmount", lhsCreditAvailableAmount), LocatorUtils.property(thatLocator, "creditAvailableAmount", rhsCreditAvailableAmount), lhsCreditAvailableAmount, rhsCreditAvailableAmount)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "creditMaxAmount", lhsCreditMaxAmount), LocatorUtils.property(thatLocator, "creditMaxAmount", rhsCreditMaxAmount), lhsCreditMaxAmount, rhsCreditMaxAmount)) {
      return false;
    }

    BigDecimal lhsCashAdvanceAvailableAmount = getCashAdvanceAvailableAmount();

    BigDecimal rhsCashAdvanceAvailableAmount = that.getCashAdvanceAvailableAmount();
    if (!strategy.equals(LocatorUtils.property(thisLocator, "cashAdvanceAvailableAmount", lhsCashAdvanceAvailableAmount), LocatorUtils.property(thatLocator, "cashAdvanceAvailableAmount", rhsCashAdvanceAvailableAmount), lhsCashAdvanceAvailableAmount, rhsCashAdvanceAvailableAmount)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "cashAdvanceMaxAmount", lhsCashAdvanceMaxAmount), LocatorUtils.property(thatLocator, "cashAdvanceMaxAmount", rhsCashAdvanceMaxAmount), lhsCashAdvanceMaxAmount, rhsCashAdvanceMaxAmount)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "cashAdvanceBalance", lhsCashAdvanceBalance), LocatorUtils.property(thatLocator, "cashAdvanceBalance", rhsCashAdvanceBalance), lhsCashAdvanceBalance, rhsCashAdvanceBalance)) {
      return false;
    }

    BigDecimal lhsCashAdvanceInterestRate = getCashAdvanceInterestRate();

    BigDecimal rhsCashAdvanceInterestRate = that.getCashAdvanceInterestRate();
    if (!strategy.equals(LocatorUtils.property(thisLocator, "cashAdvanceInterestRate", lhsCashAdvanceInterestRate), LocatorUtils.property(thatLocator, "cashAdvanceInterestRate", rhsCashAdvanceInterestRate), lhsCashAdvanceInterestRate, rhsCashAdvanceInterestRate)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "previousBalance", lhsPreviousBalance), LocatorUtils.property(thatLocator, "previousBalance", rhsPreviousBalance), lhsPreviousBalance, rhsPreviousBalance)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "statementEndDate", lhsStatementEndDate), LocatorUtils.property(thatLocator, "statementEndDate", rhsStatementEndDate), lhsStatementEndDate, rhsStatementEndDate)) {
      return false;
    }

    BigDecimal lhsStatementPurchaseAmount = getStatementPurchaseAmount();

    BigDecimal rhsStatementPurchaseAmount = that.getStatementPurchaseAmount();
    if (!strategy.equals(LocatorUtils.property(thisLocator, "statementPurchaseAmount", lhsStatementPurchaseAmount), LocatorUtils.property(thatLocator, "statementPurchaseAmount", rhsStatementPurchaseAmount), lhsStatementPurchaseAmount, rhsStatementPurchaseAmount)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "statementFinanceAmount", lhsStatementFinanceAmount), LocatorUtils.property(thatLocator, "statementFinanceAmount", rhsStatementFinanceAmount), lhsStatementFinanceAmount, rhsStatementFinanceAmount)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "pastDueAmount", lhsPastDueAmount), LocatorUtils.property(thatLocator, "pastDueAmount", rhsPastDueAmount), lhsPastDueAmount, rhsPastDueAmount)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "lastPaymentDate", lhsLastPaymentDate), LocatorUtils.property(thatLocator, "lastPaymentDate", rhsLastPaymentDate), lhsLastPaymentDate, rhsLastPaymentDate)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "statementCloseBalance", lhsStatementCloseBalance), LocatorUtils.property(thatLocator, "statementCloseBalance", rhsStatementCloseBalance), lhsStatementCloseBalance, rhsStatementCloseBalance)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "statementLateFeeAmount", lhsStatementLateFeeAmount), LocatorUtils.property(thatLocator, "statementLateFeeAmount", rhsStatementLateFeeAmount), lhsStatementLateFeeAmount, rhsStatementLateFeeAmount)) {
      return false;
    }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "creditAccountType", theCreditAccountType), currentHashCode, theCreditAccountType);

    String theDetailedDescription = getDetailedDescription();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "detailedDescription", theDetailedDescription), currentHashCode, theDetailedDescription);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "creditAvailableAmount", theCreditAvailableAmount), currentHashCode, theCreditAvailableAmount);

    BigDecimal theCreditMaxAmount = getCreditMaxAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "creditMaxAmount", theCreditMaxAmount), currentHashCode, theCreditMaxAmount);

    BigDecimal theCashAdvanceAvailableAmount = getCashAdvanceAvailableAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cashAdvanceAvailableAmount", theCashAdvanceAvailableAmount), currentHashCode, theCashAdvanceAvailableAmount);

    BigDecimal theCashAdvanceMaxAmount = getCashAdvanceMaxAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cashAdvanceMaxAmount", theCashAdvanceMaxAmount), currentHashCode, theCashAdvanceMaxAmount);

    BigDecimal theCashAdvanceBalance = getCashAdvanceBalance();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cashAdvanceBalance", theCashAdvanceBalance), currentHashCode, theCashAdvanceBalance);

    BigDecimal theCashAdvanceInterestRate = getCashAdvanceInterestRate();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cashAdvanceInterestRate", theCashAdvanceInterestRate), currentHashCode, theCashAdvanceInterestRate);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "previousBalance", thePreviousBalance), currentHashCode, thePreviousBalance);

    Calendar theStatementEndDate = getStatementEndDate();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "statementEndDate", theStatementEndDate), currentHashCode, theStatementEndDate);

    BigDecimal theStatementPurchaseAmount = getStatementPurchaseAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "statementPurchaseAmount", theStatementPurchaseAmount), currentHashCode, theStatementPurchaseAmount);

    BigDecimal theStatementFinanceAmount = getStatementFinanceAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "statementFinanceAmount", theStatementFinanceAmount), currentHashCode, theStatementFinanceAmount);

    BigDecimal thePastDueAmount = getPastDueAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "pastDueAmount", thePastDueAmount), currentHashCode, thePastDueAmount);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "lastPaymentDate", theLastPaymentDate), currentHashCode, theLastPaymentDate);

    BigDecimal theStatementCloseBalance = getStatementCloseBalance();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "statementCloseBalance", theStatementCloseBalance), currentHashCode, theStatementCloseBalance);

    BigDecimal theStatementLateFeeAmount = getStatementLateFeeAmount();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "statementLateFeeAmount", theStatementLateFeeAmount), currentHashCode, theStatementLateFeeAmount);
