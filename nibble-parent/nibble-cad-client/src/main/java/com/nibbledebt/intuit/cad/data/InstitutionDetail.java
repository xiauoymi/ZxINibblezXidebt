...
@XmlType(name = "", propOrder = { "status", "address", "emailAddress",
		"specialText", "currencyCode", "keys" })
@XmlRootElement(name = "InstitutionDetail", namespace = "http://schema.intuit.com/platform/fdatafeed/institution/v1")
public class InstitutionDetail extends Institution implements Serializable,
		Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "emailAddress",
				lhsEmailAddress), LocatorUtils.property(thatLocator,
				"emailAddress", rhsEmailAddress), lhsEmailAddress,
				rhsEmailAddress)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "specialText",
				lhsSpecialText), LocatorUtils.property(thatLocator,
				"specialText", rhsSpecialText), lhsSpecialText, rhsSpecialText)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "keys", lhsKeys),
				LocatorUtils.property(thatLocator, "keys", rhsKeys), lhsKeys,
				rhsKeys)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "emailAddress",
						theEmailAddress), currentHashCode, theEmailAddress);

		String theSpecialText = getSpecialText();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "specialText", theSpecialText),
				currentHashCode, theSpecialText);
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "keys", theKeys),
				currentHashCode, theKeys);
	...
	public static class Keys implements Serializable, Equals, HashCode {
		private static final long serialVersionUID = 1L;
...
//		@JsonProperty("key")
		...
		public boolean equals(ObjectLocator thisLocator,
			...
			List lhsKeies = (this.keies != null) && (!this.keies.isEmpty()) ? getKeies()
					: null;

			List rhsKeies = (that.keies != null) && (!that.keies.isEmpty()) ? that
					.getKeies() : null;
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "keies", lhsKeies),
					LocatorUtils.property(thatLocator, "keies", rhsKeies),
					lhsKeies, rhsKeies)) {
				return false;
			}
		...
		public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
			...
			List theKeies = (this.keies != null) && (!this.keies.isEmpty()) ? getKeies()
					: null;
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "keies", theKeies),
					currentHashCode, theKeies);
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "name", "val", "status",
				"valueLengthMin", "valueLengthMax", "displayFlag",
				"displayOrder", "mask", "instructions", "description" })
		public static class Key implements Serializable, Equals, HashCode {
			private static final long serialVersionUID = 1L;
			...
			public boolean equals(ObjectLocator thisLocator,
				...
				if (!strategy.equals(
						LocatorUtils.property(thisLocator, "val", lhsVal),
						LocatorUtils.property(thatLocator, "val", rhsVal),
						lhsVal, rhsVal)) {
					return false;
				}
				...
				if (!strategy.equals(LocatorUtils.property(thisLocator,
						"valueLengthMin", lhsValueLengthMin), LocatorUtils
						.property(thatLocator, "valueLengthMin",
								rhsValueLengthMin), lhsValueLengthMin,
						rhsValueLengthMin)) {
					return false;
				}
				...
				if (!strategy.equals(LocatorUtils.property(thisLocator,
						"valueLengthMax", lhsValueLengthMax), LocatorUtils
						.property(thatLocator, "valueLengthMax",
								rhsValueLengthMax), lhsValueLengthMax,
						rhsValueLengthMax)) {
					return false;
				}
				...
				if (!strategy.equals(LocatorUtils.property(thisLocator,
						"displayFlag", lhsDisplayFlag), LocatorUtils.property(
						thatLocator, "displayFlag", rhsDisplayFlag),
						lhsDisplayFlag, rhsDisplayFlag)) {
					return false;
				}
				...
				if (!strategy.equals(LocatorUtils.property(thisLocator,
						"displayOrder", lhsDisplayOrder),
						LocatorUtils.property(thatLocator, "displayOrder",
								rhsDisplayOrder), lhsDisplayOrder,
						rhsDisplayOrder)) {
					return false;
				}
				...
				if (!strategy.equals(
						LocatorUtils.property(thisLocator, "mask", lhsMask),
						LocatorUtils.property(thatLocator, "mask", rhsMask),
						lhsMask, rhsMask)) {
					return false;
				}
				...
				if (!strategy.equals(LocatorUtils.property(thisLocator,
						...
						LocatorUtils.property(thatLocator, "instructions",
								rhsInstructions), lhsInstructions,
						rhsInstructions)) {
					return false;
				}
			...
			public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
				...
				currentHashCode = strategy.hashCode(
						LocatorUtils.property(locator, "val", theVal),
				...
				currentHashCode = strategy.hashCode(LocatorUtils.property(
						locator, "valueLengthMin", theValueLengthMin),
						currentHashCode, theValueLengthMin);

				Integer theValueLengthMax = getValueLengthMax();
				currentHashCode = strategy.hashCode(LocatorUtils.property(
						locator, "valueLengthMax", theValueLengthMax),
						currentHashCode, theValueLengthMax);

				boolean theDisplayFlag = isDisplayFlag();
				currentHashCode = strategy.hashCode(LocatorUtils.property(
						locator, "displayFlag", theDisplayFlag),
						currentHashCode, theDisplayFlag);

				int theDisplayOrder = getDisplayOrder();
				currentHashCode = strategy.hashCode(LocatorUtils.property(
						locator, "displayOrder", theDisplayOrder),
						currentHashCode, theDisplayOrder);

				boolean theMask = isMask();
				currentHashCode = strategy.hashCode(
						LocatorUtils.property(locator, "mask", theMask),
						currentHashCode, theMask);

				String theInstructions = getInstructions();
				currentHashCode = strategy.hashCode(LocatorUtils.property(
						locator, "instructions", theInstructions),
						currentHashCode, theInstructions);

				String theDescription = getDescription();
				currentHashCode = strategy.hashCode(LocatorUtils.property(
						locator, "description", theDescription),
