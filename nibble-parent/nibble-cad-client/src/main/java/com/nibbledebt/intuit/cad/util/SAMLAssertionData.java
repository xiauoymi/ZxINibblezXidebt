...
public class SAMLAssertionData {
	...
	public SAMLAssertionData(String subject, String issuer,
			String restrictionInfo) throws SamlAssertionException {
		this.version = SAML2;
		...
		try {
			...
			throw new SamlAssertionException("Failed to generate samlId",
