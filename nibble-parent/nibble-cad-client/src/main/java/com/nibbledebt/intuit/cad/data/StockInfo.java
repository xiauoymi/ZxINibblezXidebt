...
@XmlType(name = "StockInfo", propOrder = { "stockType", "yield",
		"yieldAsOfDate" })
public class StockInfo extends SecurityInfo implements Serializable, Equals,
		HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "stockType", lhsStockType),
				LocatorUtils.property(thatLocator, "stockType", rhsStockType),
				lhsStockType, rhsStockType)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "stockType", theStockType),
				currentHashCode, theStockType);
