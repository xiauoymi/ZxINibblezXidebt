...
@XmlType(name = "InvestmentPosition", namespace = "http://schema.intuit.com/platform/fdatafeed/invposition/v1", propOrder = {
		"investmentPositionId", "changePercent", "costBasis", "currencyCode",
		"currencyRate", "currencyType", "unitPrice", "priceAsOfDate", "cusip",
		"dailyChange", "memo", "empPretaxContribAmount", "empMatchAmount",
		"heldInAccount", "holdType", "investmentAllocation",
		"investmentDirection", "paidPrice", "marketValue", "maturityValue",
		"units", "unitUserQuantity", "unitStreetQuantity", "positionType",
		"positionStatus", "secured", "inv401KSource", "reinvestmentCapGains",
		"reinvestmentDividend", "transactionType", "invSecurityType",
		"otherInfo", "optionInfo", "stockInfo", "mfInfo", "debtInfo" })
@XmlRootElement(name = "InvestmentPosition", namespace = "http://schema.intuit.com/platform/fdatafeed/invposition/v1")
public class InvestmentPosition implements Serializable, Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"investmentPositionId", lhsInvestmentPositionId), LocatorUtils
				.property(thatLocator, "investmentPositionId",
						rhsInvestmentPositionId), lhsInvestmentPositionId,
				rhsInvestmentPositionId)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"changePercent", lhsChangePercent), LocatorUtils.property(
				thatLocator, "changePercent", rhsChangePercent),
				lhsChangePercent, rhsChangePercent)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "costBasis", lhsCostBasis),
				LocatorUtils.property(thatLocator, "costBasis", rhsCostBasis),
				lhsCostBasis, rhsCostBasis)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "currencyType",
				lhsCurrencyType), LocatorUtils.property(thatLocator,
				"currencyType", rhsCurrencyType), lhsCurrencyType,
				rhsCurrencyType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"priceAsOfDate", lhsPriceAsOfDate), LocatorUtils.property(
				thatLocator, "priceAsOfDate", rhsPriceAsOfDate),
				lhsPriceAsOfDate, rhsPriceAsOfDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "dailyChange",
				lhsDailyChange), LocatorUtils.property(thatLocator,
				"dailyChange", rhsDailyChange), lhsDailyChange, rhsDailyChange)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"empPretaxContribAmount", lhsEmpPretaxContribAmount),
				LocatorUtils.property(thatLocator, "empPretaxContribAmount",
						rhsEmpPretaxContribAmount), lhsEmpPretaxContribAmount,
				rhsEmpPretaxContribAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"empMatchAmount", lhsEmpMatchAmount), LocatorUtils.property(
				thatLocator, "empMatchAmount", rhsEmpMatchAmount),
				lhsEmpMatchAmount, rhsEmpMatchAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"heldInAccount", lhsHeldInAccount), LocatorUtils.property(
				thatLocator, "heldInAccount", rhsHeldInAccount),
				lhsHeldInAccount, rhsHeldInAccount)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "holdType", lhsHoldType),
				LocatorUtils.property(thatLocator, "holdType", rhsHoldType),
				lhsHoldType, rhsHoldType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"investmentAllocation", lhsInvestmentAllocation), LocatorUtils
				.property(thatLocator, "investmentAllocation",
						rhsInvestmentAllocation), lhsInvestmentAllocation,
				rhsInvestmentAllocation)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"investmentDirection", lhsInvestmentDirection), LocatorUtils
				.property(thatLocator, "investmentDirection",
						rhsInvestmentDirection), lhsInvestmentDirection,
				rhsInvestmentDirection)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "paidPrice", lhsPaidPrice),
				LocatorUtils.property(thatLocator, "paidPrice", rhsPaidPrice),
				lhsPaidPrice, rhsPaidPrice)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "marketValue",
				lhsMarketValue), LocatorUtils.property(thatLocator,
				"marketValue", rhsMarketValue), lhsMarketValue, rhsMarketValue)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"maturityValue", lhsMaturityValue), LocatorUtils.property(
				thatLocator, "maturityValue", rhsMaturityValue),
				lhsMaturityValue, rhsMaturityValue)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"unitUserQuantity", lhsUnitUserQuantity),
				LocatorUtils.property(thatLocator, "unitUserQuantity",
						rhsUnitUserQuantity), lhsUnitUserQuantity,
				rhsUnitUserQuantity)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"unitStreetQuantity", lhsUnitStreetQuantity), LocatorUtils
				.property(thatLocator, "unitStreetQuantity",
						rhsUnitStreetQuantity), lhsUnitStreetQuantity,
				rhsUnitStreetQuantity)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"positionStatus", lhsPositionStatus), LocatorUtils.property(
				thatLocator, "positionStatus", rhsPositionStatus),
				lhsPositionStatus, rhsPositionStatus)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "secured", lhsSecured),
				LocatorUtils.property(thatLocator, "secured", rhsSecured),
				lhsSecured, rhsSecured)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"reinvestmentCapGains", lhsReinvestmentCapGains), LocatorUtils
				.property(thatLocator, "reinvestmentCapGains",
						rhsReinvestmentCapGains), lhsReinvestmentCapGains,
				rhsReinvestmentCapGains)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"reinvestmentDividend", lhsReinvestmentDividend), LocatorUtils
				.property(thatLocator, "reinvestmentDividend",
						rhsReinvestmentDividend), lhsReinvestmentDividend,
				rhsReinvestmentDividend)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"transactionType", lhsTransactionType), LocatorUtils.property(
				thatLocator, "transactionType", rhsTransactionType),
				lhsTransactionType, rhsTransactionType)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"investmentPositionId", theInvestmentPositionId),
				currentHashCode, theInvestmentPositionId);

		BigDecimal theChangePercent = getChangePercent();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"changePercent", theChangePercent), currentHashCode,
				theChangePercent);

		BigDecimal theCostBasis = getCostBasis();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "costBasis", theCostBasis),
				currentHashCode, theCostBasis);
		...
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "currencyType",
						theCurrencyType), currentHashCode, theCurrencyType);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"priceAsOfDate", thePriceAsOfDate), currentHashCode,
				thePriceAsOfDate);
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "dailyChange", theDailyChange),
				currentHashCode, theDailyChange);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"empPretaxContribAmount", theEmpPretaxContribAmount),
				currentHashCode, theEmpPretaxContribAmount);

		BigDecimal theEmpMatchAmount = getEmpMatchAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"empMatchAmount", theEmpMatchAmount), currentHashCode,
				theEmpMatchAmount);

		String theHeldInAccount = getHeldInAccount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"heldInAccount", theHeldInAccount), currentHashCode,
				theHeldInAccount);

		String theHoldType = getHoldType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "holdType", theHoldType),
				currentHashCode, theHoldType);

		String theInvestmentAllocation = getInvestmentAllocation();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"investmentAllocation", theInvestmentAllocation),
				currentHashCode, theInvestmentAllocation);

		String theInvestmentDirection = getInvestmentDirection();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"investmentDirection", theInvestmentDirection),
				currentHashCode, theInvestmentDirection);

		BigDecimal thePaidPrice = getPaidPrice();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "paidPrice", thePaidPrice),
				currentHashCode, thePaidPrice);

		BigDecimal theMarketValue = getMarketValue();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "marketValue", theMarketValue),
				currentHashCode, theMarketValue);

		BigDecimal theMaturityValue = getMaturityValue();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"maturityValue", theMaturityValue), currentHashCode,
				theMaturityValue);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"unitUserQuantity", theUnitUserQuantity), currentHashCode,
				theUnitUserQuantity);

		BigDecimal theUnitStreetQuantity = getUnitStreetQuantity();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"unitStreetQuantity", theUnitStreetQuantity), currentHashCode,
				theUnitStreetQuantity);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"positionStatus", thePositionStatus), currentHashCode,
				thePositionStatus);

		String theSecured = getSecured();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "secured", theSecured),
				currentHashCode, theSecured);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"reinvestmentCapGains", theReinvestmentCapGains),
				currentHashCode, theReinvestmentCapGains);

		Boolean theReinvestmentDividend = isReinvestmentDividend();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"reinvestmentDividend", theReinvestmentDividend),
				currentHashCode, theReinvestmentDividend);

		String theTransactionType = getTransactionType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"transactionType", theTransactionType), currentHashCode,
				theTransactionType);
