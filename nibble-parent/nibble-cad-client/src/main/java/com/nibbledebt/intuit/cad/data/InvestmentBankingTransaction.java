...
@XmlType(name = "InvestmentBankingTransaction", namespace = "http://schema.intuit.com/platform/fdatafeed/ibnktransaction/v1", propOrder = {
		"bankingTransactionType", "subaccountFundType", "banking401KSourceType" })
@XmlRootElement(name = "InvestmentBankingTransaction", namespace = "http://schema.intuit.com/platform/fdatafeed/ibnktransaction/v1")
public class InvestmentBankingTransaction extends Transaction implements
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"bankingTransactionType", lhsBankingTransactionType),
				LocatorUtils.property(thatLocator, "bankingTransactionType",
						rhsBankingTransactionType), lhsBankingTransactionType,
				rhsBankingTransactionType)) {
			return false;
		}
		...
		Banking401KSourceType rhsBanking401KSourceType = that
				.getBanking401KSourceType();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"banking401KSourceType", lhsBanking401KSourceType),
				LocatorUtils.property(thatLocator, "banking401KSourceType",
						rhsBanking401KSourceType), lhsBanking401KSourceType,
				rhsBanking401KSourceType)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"bankingTransactionType", theBankingTransactionType),
				currentHashCode, theBankingTransactionType);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"banking401KSourceType", theBanking401KSourceType),
				currentHashCode, theBanking401KSourceType);
