...
@XmlType(name = "InvestmentTransaction", namespace = "http://schema.intuit.com/platform/fdatafeed/invtransaction/v1", propOrder = {
		"reversalInstitutionTransactionId", "description", "buyType",
		"incomeType", "inv401KSource", "loanId", "optionsActionType",
		"optionsBuyType", "optionsSellType", "positionType",
		"relatedInstitutionTradeId", "relatedOptionTransType", "securedType",
		"sellReason", "sellType", "subaccountFromType", "subaccountFundType",
		"subaccountSecurityType", "subaccountToType", "transferAction",
		"unitType", "cusip", "symbol", "unitAction", "optionsSecurity",
		"tradeDate", "settleDate", "accruedInterestAmount",
		"averageCostBasisAmount", "commissionAmount", "denominator",
		"payrollDate", "purchaseDate", "gainAmount", "feesAmount",
		"fractionalUnitsCashAmount", "loadAmount", "loanInterestAmount",
		"loanPrincipalAmount", "markdownAmount", "markupAmount", "newUnits",
		"numerator", "oldUnits", "penaltyAmount", "priorYearContribution",
		"sharesPerContract", "stateWithholding", "totalAmount", "taxesAmount",
		"taxExempt", "unitPrice", "units", "withholdingAmount",
		"optionsSharesPerContract", "invSecurityType", "otherInfo",
		"optionInfo", "stockInfo", "mfInfo", "debtInfo" })
@XmlRootElement(name = "InvestmentTransaction", namespace = "http://schema.intuit.com/platform/fdatafeed/invtransaction/v1")
public class InvestmentTransaction extends Transaction implements Serializable,
		Equals, HashCode {
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		String rhsReversalInstitutionTransactionId = that
				.getReversalInstitutionTransactionId();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"reversalInstitutionTransactionId",
				lhsReversalInstitutionTransactionId), LocatorUtils.property(
				thatLocator, "reversalInstitutionTransactionId",
				rhsReversalInstitutionTransactionId),
				lhsReversalInstitutionTransactionId,
				rhsReversalInstitutionTransactionId)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "description",
				lhsDescription), LocatorUtils.property(thatLocator,
				"description", rhsDescription), lhsDescription, rhsDescription)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "buyType", lhsBuyType),
				LocatorUtils.property(thatLocator, "buyType", rhsBuyType),
				lhsBuyType, rhsBuyType)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "incomeType",
						lhsIncomeType), LocatorUtils.property(thatLocator,
						"incomeType", rhsIncomeType), lhsIncomeType,
						rhsIncomeType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"inv401KSource", lhsInv401KSource), LocatorUtils.property(
				thatLocator, "inv401KSource", rhsInv401KSource),
				lhsInv401KSource, rhsInv401KSource)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "loanId", lhsLoanId),
				LocatorUtils.property(thatLocator, "loanId", rhsLoanId),
				lhsLoanId, rhsLoanId)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"optionsActionType", lhsOptionsActionType), LocatorUtils
				.property(thatLocator, "optionsActionType",
						rhsOptionsActionType), lhsOptionsActionType,
				rhsOptionsActionType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"optionsBuyType", lhsOptionsBuyType), LocatorUtils.property(
				thatLocator, "optionsBuyType", rhsOptionsBuyType),
				lhsOptionsBuyType, rhsOptionsBuyType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"optionsSellType", lhsOptionsSellType), LocatorUtils.property(
				thatLocator, "optionsSellType", rhsOptionsSellType),
				lhsOptionsSellType, rhsOptionsSellType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "positionType",
				lhsPositionType), LocatorUtils.property(thatLocator,
				"positionType", rhsPositionType), lhsPositionType,
				rhsPositionType)) {
			return false;
		}
		...
		String rhsRelatedInstitutionTradeId = that
				.getRelatedInstitutionTradeId();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"relatedInstitutionTradeId", lhsRelatedInstitutionTradeId),
				LocatorUtils.property(thatLocator, "relatedInstitutionTradeId",
						rhsRelatedInstitutionTradeId),
				lhsRelatedInstitutionTradeId, rhsRelatedInstitutionTradeId)) {
			return false;
		}

		RelatedOptionTransType lhsRelatedOptionTransType = getRelatedOptionTransType();

		RelatedOptionTransType rhsRelatedOptionTransType = that
				.getRelatedOptionTransType();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"relatedOptionTransType", lhsRelatedOptionTransType),
				LocatorUtils.property(thatLocator, "relatedOptionTransType",
						rhsRelatedOptionTransType), lhsRelatedOptionTransType,
				rhsRelatedOptionTransType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "securedType",
				lhsSecuredType), LocatorUtils.property(thatLocator,
				"securedType", rhsSecuredType), lhsSecuredType, rhsSecuredType)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "sellReason",
						lhsSellReason), LocatorUtils.property(thatLocator,
						"sellReason", rhsSellReason), lhsSellReason,
						rhsSellReason)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "sellType", lhsSellType),
				LocatorUtils.property(thatLocator, "sellType", rhsSellType),
				lhsSellType, rhsSellType)) {
			return false;
		}

		InvestmentSubAccountType lhsSubaccountFromType = getSubaccountFromType();

		InvestmentSubAccountType rhsSubaccountFromType = that
				.getSubaccountFromType();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"subaccountFromType", lhsSubaccountFromType), LocatorUtils
				.property(thatLocator, "subaccountFromType",
						rhsSubaccountFromType), lhsSubaccountFromType,
				rhsSubaccountFromType)) {
			return false;
		}

		InvestmentSubAccountType lhsSubaccountFundType = getSubaccountFundType();

		InvestmentSubAccountType rhsSubaccountFundType = that
				.getSubaccountFundType();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"subaccountFundType", lhsSubaccountFundType), LocatorUtils
				.property(thatLocator, "subaccountFundType",
						rhsSubaccountFundType), lhsSubaccountFundType,
				rhsSubaccountFundType)) {
			return false;
		}

		InvestmentSubAccountType lhsSubaccountSecurityType = getSubaccountSecurityType();

		InvestmentSubAccountType rhsSubaccountSecurityType = that
				.getSubaccountSecurityType();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"subaccountSecurityType", lhsSubaccountSecurityType),
				LocatorUtils.property(thatLocator, "subaccountSecurityType",
						rhsSubaccountSecurityType), lhsSubaccountSecurityType,
				rhsSubaccountSecurityType)) {
			return false;
		}

		InvestmentSubAccountType lhsSubaccountToType = getSubaccountToType();

		InvestmentSubAccountType rhsSubaccountToType = that
				.getSubaccountToType();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"subaccountToType", lhsSubaccountToType),
				LocatorUtils.property(thatLocator, "subaccountToType",
						rhsSubaccountToType), lhsSubaccountToType,
				rhsSubaccountToType)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"transferAction", lhsTransferAction), LocatorUtils.property(
				thatLocator, "transferAction", rhsTransferAction),
				lhsTransferAction, rhsTransferAction)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "unitType", lhsUnitType),
				LocatorUtils.property(thatLocator, "unitType", rhsUnitType),
				lhsUnitType, rhsUnitType)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "cusip", lhsCusip),
				LocatorUtils.property(thatLocator, "cusip", rhsCusip),
				lhsCusip, rhsCusip)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "symbol", lhsSymbol),
				LocatorUtils.property(thatLocator, "symbol", rhsSymbol),
				lhsSymbol, rhsSymbol)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "unitAction",
						lhsUnitAction), LocatorUtils.property(thatLocator,
						"unitAction", rhsUnitAction), lhsUnitAction,
						rhsUnitAction)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"optionsSecurity", lhsOptionsSecurity), LocatorUtils.property(
				thatLocator, "optionsSecurity", rhsOptionsSecurity),
				lhsOptionsSecurity, rhsOptionsSecurity)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "tradeDate", lhsTradeDate),
				LocatorUtils.property(thatLocator, "tradeDate", rhsTradeDate),
				lhsTradeDate, rhsTradeDate)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "settleDate",
						lhsSettleDate), LocatorUtils.property(thatLocator,
						"settleDate", rhsSettleDate), lhsSettleDate,
						rhsSettleDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"accruedInterestAmount", lhsAccruedInterestAmount),
				LocatorUtils.property(thatLocator, "accruedInterestAmount",
						rhsAccruedInterestAmount), lhsAccruedInterestAmount,
				rhsAccruedInterestAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"averageCostBasisAmount", lhsAverageCostBasisAmount),
				LocatorUtils.property(thatLocator, "averageCostBasisAmount",
						rhsAverageCostBasisAmount), lhsAverageCostBasisAmount,
				rhsAverageCostBasisAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"commissionAmount", lhsCommissionAmount),
				LocatorUtils.property(thatLocator, "commissionAmount",
						rhsCommissionAmount), lhsCommissionAmount,
				rhsCommissionAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "denominator",
				lhsDenominator), LocatorUtils.property(thatLocator,
				"denominator", rhsDenominator), lhsDenominator, rhsDenominator)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "payrollDate",
				lhsPayrollDate), LocatorUtils.property(thatLocator,
				"payrollDate", rhsPayrollDate), lhsPayrollDate, rhsPayrollDate)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "purchaseDate",
				lhsPurchaseDate), LocatorUtils.property(thatLocator,
				"purchaseDate", rhsPurchaseDate), lhsPurchaseDate,
				rhsPurchaseDate)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "gainAmount",
						lhsGainAmount), LocatorUtils.property(thatLocator,
						"gainAmount", rhsGainAmount), lhsGainAmount,
						rhsGainAmount)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "feesAmount",
						lhsFeesAmount), LocatorUtils.property(thatLocator,
						"feesAmount", rhsFeesAmount), lhsFeesAmount,
						rhsFeesAmount)) {
			return false;
		}
		...
		BigDecimal rhsFractionalUnitsCashAmount = that
				.getFractionalUnitsCashAmount();
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"fractionalUnitsCashAmount", lhsFractionalUnitsCashAmount),
				LocatorUtils.property(thatLocator, "fractionalUnitsCashAmount",
						rhsFractionalUnitsCashAmount),
				lhsFractionalUnitsCashAmount, rhsFractionalUnitsCashAmount)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "loadAmount",
						lhsLoadAmount), LocatorUtils.property(thatLocator,
						"loadAmount", rhsLoadAmount), lhsLoadAmount,
						rhsLoadAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"loanInterestAmount", lhsLoanInterestAmount), LocatorUtils
				.property(thatLocator, "loanInterestAmount",
						rhsLoanInterestAmount), lhsLoanInterestAmount,
				rhsLoanInterestAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"loanPrincipalAmount", lhsLoanPrincipalAmount), LocatorUtils
				.property(thatLocator, "loanPrincipalAmount",
						rhsLoanPrincipalAmount), lhsLoanPrincipalAmount,
				rhsLoanPrincipalAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"markdownAmount", lhsMarkdownAmount), LocatorUtils.property(
				thatLocator, "markdownAmount", rhsMarkdownAmount),
				lhsMarkdownAmount, rhsMarkdownAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "markupAmount",
				lhsMarkupAmount), LocatorUtils.property(thatLocator,
				"markupAmount", rhsMarkupAmount), lhsMarkupAmount,
				rhsMarkupAmount)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "newUnits", lhsNewUnits),
				LocatorUtils.property(thatLocator, "newUnits", rhsNewUnits),
				lhsNewUnits, rhsNewUnits)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "numerator", lhsNumerator),
				LocatorUtils.property(thatLocator, "numerator", rhsNumerator),
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "oldUnits", lhsOldUnits),
				LocatorUtils.property(thatLocator, "oldUnits", rhsOldUnits),
				lhsOldUnits, rhsOldUnits)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"penaltyAmount", lhsPenaltyAmount), LocatorUtils.property(
				thatLocator, "penaltyAmount", rhsPenaltyAmount),
				lhsPenaltyAmount, rhsPenaltyAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"priorYearContribution", lhsPriorYearContribution),
				LocatorUtils.property(thatLocator, "priorYearContribution",
						rhsPriorYearContribution), lhsPriorYearContribution,
				rhsPriorYearContribution)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"stateWithholding", lhsStateWithholding),
				LocatorUtils.property(thatLocator, "stateWithholding",
						rhsStateWithholding), lhsStateWithholding,
				rhsStateWithholding)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "totalAmount",
				lhsTotalAmount), LocatorUtils.property(thatLocator,
				"totalAmount", rhsTotalAmount), lhsTotalAmount, rhsTotalAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator, "taxesAmount",
				lhsTaxesAmount), LocatorUtils.property(thatLocator,
				"taxesAmount", rhsTaxesAmount), lhsTaxesAmount, rhsTaxesAmount)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "taxExempt", lhsTaxExempt),
				LocatorUtils.property(thatLocator, "taxExempt", rhsTaxExempt),
				lhsTaxExempt, rhsTaxExempt)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "units", lhsUnits),
				LocatorUtils.property(thatLocator, "units", rhsUnits),
				lhsUnits, rhsUnits)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"withholdingAmount", lhsWithholdingAmount), LocatorUtils
				.property(thatLocator, "withholdingAmount",
						rhsWithholdingAmount), lhsWithholdingAmount,
				rhsWithholdingAmount)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"optionsSharesPerContract", lhsOptionsSharesPerContract),
				LocatorUtils.property(thatLocator, "optionsSharesPerContract",
						rhsOptionsSharesPerContract),
				lhsOptionsSharesPerContract, rhsOptionsSharesPerContract)) {
			return false;
		}
		...
		if (!strategy.equals(LocatorUtils.property(thisLocator,
				"invSecurityType", lhsInvSecurityType), LocatorUtils.property(
				thatLocator, "invSecurityType", rhsInvSecurityType),
				lhsInvSecurityType, rhsInvSecurityType)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "otherInfo", lhsOtherInfo),
				LocatorUtils.property(thatLocator, "otherInfo", rhsOtherInfo),
				lhsOtherInfo, rhsOtherInfo)) {
			return false;
		}
		...
		if (!strategy
				.equals(LocatorUtils.property(thisLocator, "optionInfo",
						lhsOptionInfo), LocatorUtils.property(thatLocator,
						"optionInfo", rhsOptionInfo), lhsOptionInfo,
						rhsOptionInfo)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "stockInfo", lhsStockInfo),
				LocatorUtils.property(thatLocator, "stockInfo", rhsStockInfo),
				lhsStockInfo, rhsStockInfo)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "mfInfo", lhsMfInfo),
				LocatorUtils.property(thatLocator, "mfInfo", rhsMfInfo),
				lhsMfInfo, rhsMfInfo)) {
			return false;
		}
		...
		if (!strategy.equals(
				LocatorUtils.property(thisLocator, "debtInfo", lhsDebtInfo),
				LocatorUtils.property(thatLocator, "debtInfo", rhsDebtInfo),
				lhsDebtInfo, rhsDebtInfo)) {
			return false;
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"reversalInstitutionTransactionId",
				theReversalInstitutionTransactionId), currentHashCode,
				theReversalInstitutionTransactionId);

		String theDescription = getDescription();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "description", theDescription),
				currentHashCode, theDescription);

		BuyType theBuyType = getBuyType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "buyType", theBuyType),
				currentHashCode, theBuyType);

		IncomeType theIncomeType = getIncomeType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "incomeType", theIncomeType),
				currentHashCode, theIncomeType);

		String theInv401KSource = getInv401KSource();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"inv401KSource", theInv401KSource), currentHashCode,
				theInv401KSource);

		String theLoanId = getLoanId();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "loanId", theLoanId),
				currentHashCode, theLoanId);

		OptionsActionType theOptionsActionType = getOptionsActionType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"optionsActionType", theOptionsActionType), currentHashCode,
				theOptionsActionType);

		OptionsBuyType theOptionsBuyType = getOptionsBuyType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"optionsBuyType", theOptionsBuyType), currentHashCode,
				theOptionsBuyType);

		OptionsSellType theOptionsSellType = getOptionsSellType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"optionsSellType", theOptionsSellType), currentHashCode,
				theOptionsSellType);

		PositionType thePositionType = getPositionType();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "positionType",
						thePositionType), currentHashCode, thePositionType);

		String theRelatedInstitutionTradeId = getRelatedInstitutionTradeId();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"relatedInstitutionTradeId", theRelatedInstitutionTradeId),
				currentHashCode, theRelatedInstitutionTradeId);

		RelatedOptionTransType theRelatedOptionTransType = getRelatedOptionTransType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"relatedOptionTransType", theRelatedOptionTransType),
				currentHashCode, theRelatedOptionTransType);

		SecuredType theSecuredType = getSecuredType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "securedType", theSecuredType),
				currentHashCode, theSecuredType);

		SellReason theSellReason = getSellReason();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "sellReason", theSellReason),
				currentHashCode, theSellReason);

		SellType theSellType = getSellType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "sellType", theSellType),
				currentHashCode, theSellType);

		InvestmentSubAccountType theSubaccountFromType = getSubaccountFromType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"subaccountFromType", theSubaccountFromType), currentHashCode,
				theSubaccountFromType);

		InvestmentSubAccountType theSubaccountFundType = getSubaccountFundType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"subaccountFundType", theSubaccountFundType), currentHashCode,
				theSubaccountFundType);

		InvestmentSubAccountType theSubaccountSecurityType = getSubaccountSecurityType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"subaccountSecurityType", theSubaccountSecurityType),
				currentHashCode, theSubaccountSecurityType);

		InvestmentSubAccountType theSubaccountToType = getSubaccountToType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"subaccountToType", theSubaccountToType), currentHashCode,
				theSubaccountToType);

		TransferAction theTransferAction = getTransferAction();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"transferAction", theTransferAction), currentHashCode,
				theTransferAction);

		String theUnitType = getUnitType();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "unitType", theUnitType),
				currentHashCode, theUnitType);

		String theCusip = getCusip();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "cusip", theCusip),
				currentHashCode, theCusip);

		String theSymbol = getSymbol();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "symbol", theSymbol),
				currentHashCode, theSymbol);

		String theUnitAction = getUnitAction();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "unitAction", theUnitAction),
				currentHashCode, theUnitAction);

		String theOptionsSecurity = getOptionsSecurity();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"optionsSecurity", theOptionsSecurity), currentHashCode,
				theOptionsSecurity);

		Calendar theTradeDate = getTradeDate();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "tradeDate", theTradeDate),
				currentHashCode, theTradeDate);

		Calendar theSettleDate = getSettleDate();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "settleDate", theSettleDate),
				currentHashCode, theSettleDate);

		BigDecimal theAccruedInterestAmount = getAccruedInterestAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"accruedInterestAmount", theAccruedInterestAmount),
				currentHashCode, theAccruedInterestAmount);

		BigDecimal theAverageCostBasisAmount = getAverageCostBasisAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"averageCostBasisAmount", theAverageCostBasisAmount),
				currentHashCode, theAverageCostBasisAmount);

		BigDecimal theCommissionAmount = getCommissionAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"commissionAmount", theCommissionAmount), currentHashCode,
				theCommissionAmount);

		BigDecimal theDenominator = getDenominator();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "denominator", theDenominator),
				currentHashCode, theDenominator);

		Calendar thePayrollDate = getPayrollDate();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "payrollDate", thePayrollDate),
				currentHashCode, thePayrollDate);

		Calendar thePurchaseDate = getPurchaseDate();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "purchaseDate",
						thePurchaseDate), currentHashCode, thePurchaseDate);

		BigDecimal theGainAmount = getGainAmount();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "gainAmount", theGainAmount),
				currentHashCode, theGainAmount);

		BigDecimal theFeesAmount = getFeesAmount();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "feesAmount", theFeesAmount),
				currentHashCode, theFeesAmount);

		BigDecimal theFractionalUnitsCashAmount = getFractionalUnitsCashAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"fractionalUnitsCashAmount", theFractionalUnitsCashAmount),
				currentHashCode, theFractionalUnitsCashAmount);

		BigDecimal theLoadAmount = getLoadAmount();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "loadAmount", theLoadAmount),
				currentHashCode, theLoadAmount);

		BigDecimal theLoanInterestAmount = getLoanInterestAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"loanInterestAmount", theLoanInterestAmount), currentHashCode,
				theLoanInterestAmount);

		BigDecimal theLoanPrincipalAmount = getLoanPrincipalAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"loanPrincipalAmount", theLoanPrincipalAmount),
				currentHashCode, theLoanPrincipalAmount);

		BigDecimal theMarkdownAmount = getMarkdownAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"markdownAmount", theMarkdownAmount), currentHashCode,
				theMarkdownAmount);

		BigDecimal theMarkupAmount = getMarkupAmount();
		currentHashCode = strategy
				.hashCode(LocatorUtils.property(locator, "markupAmount",
						theMarkupAmount), currentHashCode, theMarkupAmount);

		BigDecimal theNewUnits = getNewUnits();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "newUnits", theNewUnits),
				currentHashCode, theNewUnits);

		BigDecimal theNumerator = getNumerator();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "numerator", theNumerator),
				currentHashCode, theNumerator);

		BigDecimal theOldUnits = getOldUnits();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "oldUnits", theOldUnits),
				currentHashCode, theOldUnits);

		BigDecimal thePenaltyAmount = getPenaltyAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"penaltyAmount", thePenaltyAmount), currentHashCode,
				thePenaltyAmount);

		Boolean thePriorYearContribution = isPriorYearContribution();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"priorYearContribution", thePriorYearContribution),
				currentHashCode, thePriorYearContribution);
		...
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"stateWithholding", theStateWithholding), currentHashCode,
				theStateWithholding);

		BigDecimal theTotalAmount = getTotalAmount();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "totalAmount", theTotalAmount),
				currentHashCode, theTotalAmount);

		BigDecimal theTaxesAmount = getTaxesAmount();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "taxesAmount", theTaxesAmount),
				currentHashCode, theTaxesAmount);

		Boolean theTaxExempt = isTaxExempt();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "taxExempt", theTaxExempt),
				currentHashCode, theTaxExempt);
		...
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "units", theUnits),
				currentHashCode, theUnits);

		BigDecimal theWithholdingAmount = getWithholdingAmount();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"withholdingAmount", theWithholdingAmount), currentHashCode,
				theWithholdingAmount);

		Long theOptionsSharesPerContract = getOptionsSharesPerContract();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"optionsSharesPerContract", theOptionsSharesPerContract),
				currentHashCode, theOptionsSharesPerContract);

		InvSecurityType theInvSecurityType = getInvSecurityType();
		currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
				"invSecurityType", theInvSecurityType), currentHashCode,
				theInvSecurityType);

		OtherInfo theOtherInfo = getOtherInfo();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "otherInfo", theOtherInfo),
				currentHashCode, theOtherInfo);

		OptionInfo theOptionInfo = getOptionInfo();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "optionInfo", theOptionInfo),
				currentHashCode, theOptionInfo);

		StockInfo theStockInfo = getStockInfo();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "stockInfo", theStockInfo),
				currentHashCode, theStockInfo);

		MFInfo theMfInfo = getMfInfo();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "mfInfo", theMfInfo),
				currentHashCode, theMfInfo);

		DebtInfo theDebtInfo = getDebtInfo();
		currentHashCode = strategy.hashCode(
				LocatorUtils.property(locator, "debtInfo", theDebtInfo),
				currentHashCode, theDebtInfo);
