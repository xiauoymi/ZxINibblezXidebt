...
@XmlType(name="Categorization", namespace="http://schema.intuit.com/platform/fdatafeed/transaction/v1", propOrder={"common", "contexts"})
  ...
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy)
  {
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "common", lhsCommon), LocatorUtils.property(thatLocator, "common", rhsCommon), lhsCommon, rhsCommon)) {
      return false;
    }
    List<Context> lhsContexts = (this.contexts != null) && (!this.contexts.isEmpty()) ? getContexts() : null;
    
    List<Context> rhsContexts = (that.contexts != null) && (!that.contexts.isEmpty()) ? that.getContexts() : null;
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy)
  {
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "common", theCommon), currentHashCode, theCommon);
    
    List<Context> theContexts = (this.contexts != null) && (!this.contexts.isEmpty()) ? getContexts() : null;
    ...
    implements Serializable, Equals, HashCode
  {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy)
    {
      ...
      if (!strategy.equals(LocatorUtils.property(thisLocator, "normalizedPayeeName", lhsNormalizedPayeeName), LocatorUtils.property(thatLocator, "normalizedPayeeName", rhsNormalizedPayeeName), lhsNormalizedPayeeName, rhsNormalizedPayeeName)) {
        return false;
      }
      String lhsMerchant = getMerchant();
      
      String rhsMerchant = that.getMerchant();
      if (!strategy.equals(LocatorUtils.property(thisLocator, "merchant", lhsMerchant), LocatorUtils.property(thatLocator, "merchant", rhsMerchant), lhsMerchant, rhsMerchant)) {
        return false;
      }
      Integer lhsSic = getSic();
      
      Integer rhsSic = that.getSic();
      if (!strategy.equals(LocatorUtils.property(thisLocator, "sic", lhsSic), LocatorUtils.property(thatLocator, "sic", rhsSic), lhsSic, rhsSic)) {
        return false;
      }
      return true;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy)
    {
      ...
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "normalizedPayeeName", theNormalizedPayeeName), currentHashCode, theNormalizedPayeeName);
      
      String theMerchant = getMerchant();
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "merchant", theMerchant), currentHashCode, theMerchant);
      
      Integer theSic = getSic();
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sic", theSic), currentHashCode, theSic);
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name="", propOrder={"source", "categoryName", "contextType", "scheduleC"})
    ...
    implements Serializable, Equals, HashCode
  {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy)
    {
      ...
      if (!strategy.equals(LocatorUtils.property(thisLocator, "scheduleC", lhsScheduleC), LocatorUtils.property(thatLocator, "scheduleC", rhsScheduleC), lhsScheduleC, rhsScheduleC)) {
        return false;
      }
      return true;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy)
    {
      ...
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scheduleC", theScheduleC), currentHashCode, theScheduleC);
