  ...
  extends Exception
{
  ...
  public AggCatException(String errorCode, String errorMessage, Status status, String errorResponseText)
  {
    super(errorCode + " : " + errorMessage);
    this.errorCode = errorCode;
    this.errorMessage = errorMessage;
  ...
  public AggCatException(String errorCode, String errorMessage, Throwable throwable)
  {
