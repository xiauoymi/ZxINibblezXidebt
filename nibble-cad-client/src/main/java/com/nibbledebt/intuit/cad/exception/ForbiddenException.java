  ...
  extends AggCatException
{
  ...
  public ForbiddenException(String errorCode, String errorMessage, Status status, String errorResponseText)
  {
  ...
  public ForbiddenException(String errorCode, String errorMessage, Throwable throwable)
  {
