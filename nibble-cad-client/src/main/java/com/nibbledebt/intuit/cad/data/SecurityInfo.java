...
@XmlType(name="SecurityInfo", propOrder={"assetClass", "fiAssetClass", "ticker", "uniqueId", "uniqueIdType", "asOfDate", "rating", "percent", "fiId", "name", "fundName", "memo", "symbolRefId", "currencyCode", "currencyRate", "unitPrice"})
@XmlSeeAlso({OtherInfo.class, OptionInfo.class, StockInfo.class, MFInfo.class, DebtInfo.class})
  ...
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "assetClass", lhsAssetClass), LocatorUtils.property(thatLocator, "assetClass", rhsAssetClass), lhsAssetClass, rhsAssetClass)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "fiAssetClass", lhsFiAssetClass), LocatorUtils.property(thatLocator, "fiAssetClass", rhsFiAssetClass), lhsFiAssetClass, rhsFiAssetClass)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "ticker", lhsTicker), LocatorUtils.property(thatLocator, "ticker", rhsTicker), lhsTicker, rhsTicker)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "uniqueIdType", lhsUniqueIdType), LocatorUtils.property(thatLocator, "uniqueIdType", rhsUniqueIdType), lhsUniqueIdType, rhsUniqueIdType)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "fundName", lhsFundName), LocatorUtils.property(thatLocator, "fundName", rhsFundName), lhsFundName, rhsFundName)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "symbolRefId", lhsSymbolRefId), LocatorUtils.property(thatLocator, "symbolRefId", rhsSymbolRefId), lhsSymbolRefId, rhsSymbolRefId)) {
      return false;
    }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "assetClass", theAssetClass), currentHashCode, theAssetClass);

    String theFiAssetClass = getFiAssetClass();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "fiAssetClass", theFiAssetClass), currentHashCode, theFiAssetClass);

    String theTicker = getTicker();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ticker", theTicker), currentHashCode, theTicker);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "uniqueIdType", theUniqueIdType), currentHashCode, theUniqueIdType);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "fundName", theFundName), currentHashCode, theFundName);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "symbolRefId", theSymbolRefId), currentHashCode, theSymbolRefId);
