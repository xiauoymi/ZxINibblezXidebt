...
@XmlType(name="File", namespace="http://schema.intuit.com/platform/fdatafeed/files/v1", propOrder={"name", "size", "modifiedTs"})
  ...
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy)
  {
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "modifiedTs", lhsModifiedTs), LocatorUtils.property(thatLocator, "modifiedTs", rhsModifiedTs), lhsModifiedTs, rhsModifiedTs)) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy)
  {
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "modifiedTs", theModifiedTs), currentHashCode, theModifiedTs);
