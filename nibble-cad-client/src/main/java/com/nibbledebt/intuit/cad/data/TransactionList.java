  ...
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy)
  {
    ...
    List<RewardsTransaction> lhsRewardsTransactions = (this.rewardsTransactions != null) && (!this.rewardsTransactions.isEmpty()) ? getRewardsTransactions() : null;
    
    List<RewardsTransaction> rhsRewardsTransactions = (that.rewardsTransactions != null) && (!that.rewardsTransactions.isEmpty()) ? that.getRewardsTransactions() : null;
    ...
    List<InvestmentTransaction> lhsInvestmentTransactions = (this.investmentTransactions != null) && (!this.investmentTransactions.isEmpty()) ? getInvestmentTransactions() : null;
    
    List<InvestmentTransaction> rhsInvestmentTransactions = (that.investmentTransactions != null) && (!that.investmentTransactions.isEmpty()) ? that.getInvestmentTransactions() : null;
    ...
    List<LoanTransaction> lhsLoanTransactions = (this.loanTransactions != null) && (!this.loanTransactions.isEmpty()) ? getLoanTransactions() : null;
    
    List<LoanTransaction> rhsLoanTransactions = (that.loanTransactions != null) && (!that.loanTransactions.isEmpty()) ? that.getLoanTransactions() : null;
    ...
    List<InvestmentBankingTransaction> lhsInvestmentBankingTransactions = (this.investmentBankingTransactions != null) && (!this.investmentBankingTransactions.isEmpty()) ? getInvestmentBankingTransactions() : null;
    
    List<InvestmentBankingTransaction> rhsInvestmentBankingTransactions = (that.investmentBankingTransactions != null) && (!that.investmentBankingTransactions.isEmpty()) ? that.getInvestmentBankingTransactions() : null;
    ...
    List<CreditCardTransaction> lhsCreditCardTransactions = (this.creditCardTransactions != null) && (!this.creditCardTransactions.isEmpty()) ? getCreditCardTransactions() : null;
    
    List<CreditCardTransaction> rhsCreditCardTransactions = (that.creditCardTransactions != null) && (!that.creditCardTransactions.isEmpty()) ? that.getCreditCardTransactions() : null;
    ...
    List<BankingTransaction> lhsBankingTransactions = (this.bankingTransactions != null) && (!this.bankingTransactions.isEmpty()) ? getBankingTransactions() : null;
    
    List<BankingTransaction> rhsBankingTransactions = (that.bankingTransactions != null) && (!that.bankingTransactions.isEmpty()) ? that.getBankingTransactions() : null;
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy)
  {
    ...
    List<RewardsTransaction> theRewardsTransactions = (this.rewardsTransactions != null) && (!this.rewardsTransactions.isEmpty()) ? getRewardsTransactions() : null;
    ...
    List<InvestmentTransaction> theInvestmentTransactions = (this.investmentTransactions != null) && (!this.investmentTransactions.isEmpty()) ? getInvestmentTransactions() : null;
    ...
    List<LoanTransaction> theLoanTransactions = (this.loanTransactions != null) && (!this.loanTransactions.isEmpty()) ? getLoanTransactions() : null;
    ...
    List<InvestmentBankingTransaction> theInvestmentBankingTransactions = (this.investmentBankingTransactions != null) && (!this.investmentBankingTransactions.isEmpty()) ? getInvestmentBankingTransactions() : null;
    ...
    List<CreditCardTransaction> theCreditCardTransactions = (this.creditCardTransactions != null) && (!this.creditCardTransactions.isEmpty()) ? getCreditCardTransactions() : null;
    ...
    List<BankingTransaction> theBankingTransactions = (this.bankingTransactions != null) && (!this.bankingTransactions.isEmpty()) ? getBankingTransactions() : null;
