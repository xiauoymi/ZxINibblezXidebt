  ...
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy)
  {
    ...
    List<ErrorInfo> lhsErrorInfos = (this.errorInfos != null) && (!this.errorInfos.isEmpty()) ? getErrorInfos() : null;
    
    List<ErrorInfo> rhsErrorInfos = (that.errorInfos != null) && (!that.errorInfos.isEmpty()) ? that.getErrorInfos() : null;
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy)
  {
    ...
    List<ErrorInfo> theErrorInfos = (this.errorInfos != null) && (!this.errorInfos.isEmpty()) ? getErrorInfos() : null;
