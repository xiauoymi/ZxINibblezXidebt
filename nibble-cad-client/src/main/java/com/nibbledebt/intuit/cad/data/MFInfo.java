...
@XmlType(name="MFInfo", propOrder={"mfType", "fundManager", "yield", "yieldAsOfDate", "secCurrencyCode", "secCurrencyRate"})
public class MFInfo extends SecurityInfo
  implements Serializable, Equals, HashCode
{
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "mfType", lhsMfType), LocatorUtils.property(thatLocator, "mfType", rhsMfType), lhsMfType, rhsMfType)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "fundManager", lhsFundManager), LocatorUtils.property(thatLocator, "fundManager", rhsFundManager), lhsFundManager, rhsFundManager)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "secCurrencyCode", lhsSecCurrencyCode), LocatorUtils.property(thatLocator, "secCurrencyCode", rhsSecCurrencyCode), lhsSecCurrencyCode, rhsSecCurrencyCode)) {
      return false;
    }
    ...
    if (!strategy.equals(LocatorUtils.property(thisLocator, "secCurrencyRate", lhsSecCurrencyRate), LocatorUtils.property(thatLocator, "secCurrencyRate", rhsSecCurrencyRate), lhsSecCurrencyRate, rhsSecCurrencyRate)) {
      return false;
    }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mfType", theMfType), currentHashCode, theMfType);

    String theFundManager = getFundManager();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "fundManager", theFundManager), currentHashCode, theFundManager);
    ...
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "secCurrencyCode", theSecCurrencyCode), currentHashCode, theSecCurrencyCode);

    BigDecimal theSecCurrencyRate = getSecCurrencyRate();
    currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "secCurrencyRate", theSecCurrencyRate), currentHashCode, theSecCurrencyRate);
